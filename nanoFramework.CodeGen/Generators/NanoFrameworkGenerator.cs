...
namespace CodeGen.Generators
{
    ...
    internal static class NanoFrameworkGenerator
    {
        ...
        /// </summary>
        /// <param name="unitsNetRootDir">The root directory of Units Net.</param>
        /// <param name="nanoRoot">The root directory of the current repository.</param>
        /// <param name="quantities">The quantities to create.</param>
        /// <param name="quantityNameToUnitEnumValues">The mapping of quantity name to unit enum values.</param>
        public static void Generate(
            string unitsNetRootDir,
            string nanoRoot,
            Quantity[] quantities,
            QuantityNameToUnitEnumValues quantityNameToUnitEnumValues)
        {
            // get latest version of .NET nanoFramework mscorlib
            ILogger logger = NullLogger.Instance;

            NanoFrameworkVersions versions = ParseCurrentNanoFrameworkVersions(nanoRoot);
        ...
        private static NanoFrameworkVersions ParseCurrentNanoFrameworkVersions(string rootDir)
        {
            ...
            var generatedCodePath = Path.Combine(rootDir, "nanoFramework.UnitsNet", "GeneratedCode");
